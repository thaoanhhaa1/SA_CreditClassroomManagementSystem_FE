            ...
            <div className={`bg-white rounded-sm p-4 ${cx("weekly-schedule-container")}`}>
                ...
                <div className="text-right justify-end flex items-center pb-3">
                    ...
                    <div className="ml-2 flex items-center gap-x-2">
                        ...
                        <button className={`flex items-center justify-center gap px-3 py-1 ${cx('action-btn')} text-white`}>
                ...
                <div className='pt-2 border-t'>
                    <table className={`${cx("schedule-table")}`}>
                        <thead className={`${cx("schedule-table-header")}`}>
                            <tr className='flex'>
                                <th
                                    className={`${cx("schedule-table-header-cell", "schedule-table-header-cell-first")}`}
                                >
                                    <p className='text-sm'>Ca học</p>
                                </th>
                                <th
                                    className={`${cx("schedule-table-header-cell")} flex-1`}
                                >
                        ...
                        <tbody
                            className={`${cx("schedule-table-body")}`}
                        >
                            <tr
                                className={`${cx("schedule-table-row")} flex`}
                            >
                                <td
                                    className={`${cx("schedule-table-cell", "schedule-table-cell-first")}`}
                                >Sáng</td>
                                <td
                                    className={`${cx("schedule-table-cell")} flex-1`}
                                >
                                    <div className={`${cx("course-item", "theory-course")}`}>
                                        <p
                                            className={`${cx("course-name")}`}
                                        >Nhập môn dữ liệu lớn</p>
                                        <p
                                            className={`${cx("course-info")}`}
                                        >
                                            DHKTPM16A - 420300232905
                                        </p>
                                        <p
                                            className={`${cx("course-info")}`}
                                        >Tiết: 4 - 6</p>
                ...
                <div className={`flex items-center mt-5 gap-4`}>
                    <div className={`flex items-center gap-1`}>
                       <div
                        className={`${cx("badge-theory-course")}`}
                       ></div>
                    ...
                    <div className={`flex items-center gap-1`}>
                       <div
                        className={`${cx("badge-practice-course")}`}
                       ></div>
                    ...
                    <div className={`flex items-center gap-1`}>
                       <div
                        className={`${cx("badge-online-course")}`}
                       ></div>
                    ...
                    <div className={`flex items-center gap-1`}>
                       <div
                        className={`${cx("badge-exam-course")}`}
                       ></div>
